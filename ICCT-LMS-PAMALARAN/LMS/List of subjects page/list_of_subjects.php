...
<html lang="en">
	...
	<body>
				...
				<div class="container">
					...
					<div class="collapse navbar-collapse" id="navmenu">
						<ul class="navbar-nav ms-auto">
							...
							<li class="nav-item d-block d-sm-none">
								<a href="attendance_page.php" class="nav-link">Attendance</a>
							</li>
							<li class="nav-item d-block d-sm-none">
								<a href="list_of_subjects.php" class="nav-link"
									>List of Subjects</a
								>
							</li>
							<li class="nav-item d-block d-sm-none">
								...
								<div class="bg-form">
									<div class="input-name d-flex">
										<p style="margin-left: auto; margin-right: auto"
											><?php include 'database/Usersinfo.php';?>
										</p>
									</div>
								</div>
							</div>
						...
						<div class="dashboard p-2 bg-primary rounded">
							<ul>
								<li class="list-unstyled mb-2">
									<a href="home.php" class="text-light text-decoration-none"
										>Home</a
									>
								</li>
								<li class="list-unstyled mb-2">
		...
		<!-- importing app.js -->
		<script type="module" src="./list_of_subjects.js"></script>
	</body>
</html>
